...
var createDeaultQRContainer = function () {
    ...
    descript.innerHTML = '<div>1. Scan for pay with your NAS mobile Wallet </div> <div>2.Make sure your NAS mobile Wallet  and current account address is the same</div> <div> 3. Please complete the payment within 30s</div>'
    ...
    qrcontainer.appendChild(descript)
